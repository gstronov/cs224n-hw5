...
def pad_sents_char(sents, char_pad_token):
    ...
    for s in sents:
        sent_padded = [[char_pad_token] * max_word_length] * max_sent_len
        padded_words = []
        for word in s:
            padded_word = [char_pad_token] * max_word_length
            padded_word[:len(word)] = word[:max_word_length] ##make sure not removing <end>
            padded_words.append(padded_word)
        sent_padded[:len(padded_words)] = padded_words
